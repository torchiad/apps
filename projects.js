// HUB utilities — hand-written, never overwritten by generate.js
(function () {
  function fmtDate(d) {
  ...
  window.HUB = { fmtDate, fmtUses, pop, popSoft, thumbBold };
})();

// ── generated by generate.js — do not edit below this line ──
window.PROJECTS = [];
